...
I'm currently being run and developed by Jonas747#0001 (105487308693757952) but the bot is open source (<https://github.com/mmuyskens/yagpdb>), so if you know Go and want to make some contributions, feel free to make a PR.
