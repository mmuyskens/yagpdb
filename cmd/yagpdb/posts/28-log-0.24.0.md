...
There's some backend changes not mentioned in the following changelog, check the [github repo](https://github.com/mmuyskens/yagpdb) for more detailed changes
