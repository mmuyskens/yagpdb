...
```bash
git clone https://github.com/mmuyskens/yagpdb
...
go get -v -d github.com/mmuyskens/yagpdb/cmd/yagpdb
cd $GOPATH/src/github.com/mmuyskens/yagpdb/cmd/yagpdb
go build
```
...
[See the Issues Tab for more](https://github.com/mmuyskens/yagpdb/issues)
